...
import { getShifts } from '../../../../actions/AttendanceSchedule';
import ShiftDetail from './ShiftDetail';
import ShiftTableCell from './ShiftTableCell';
import UploadShift from './UploadShift';

function AttendanceShiftTable(props) {
  ...
  const refreshList = async ({ start_date, end_date, id_user }, page, limit) => {
    const { data, total, status } = await getShifts({
      start_date,
      end_date,
      id_user,
      page: page + 1,
...
export default AttendanceShiftTable;
