...
import PatroliShiftTable from '../components/PatroliShiftTable';

function PatroliSchedule(props) {
  const { match } = props;
      ...
      <div className="row mb-md-3">
        <div className="col-12">
          <div className="jr-card p-0">
            ...
            <div className="p-4">
              <PatroliShiftTable id_user={idUser} start_date={startDate} end_date={endDate} idUser={idUser} />
            </div>
          </div>
        </div>
      </div>
...
export default PatroliSchedule;
